...
ORDER = ["microban", "pullban", "autoban", "microban2", "microban3",
...
def _enrich(name: str) -> list[dict]:
    ...
    levels = {l.n: l for l in load_corpus(corpus_xsb(name))}
...
def main() -> None:
    ...
    out += ["", "## Per-set breakdown (with solutions vs geometry-only)", "",
